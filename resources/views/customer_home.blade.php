        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{ asset('dashboard_assets') }}/img/img4.jpg" class="wd-32 rounded-circle" alt="">
            </a>
  ...
  <div class="sl-mainpanel">
      <footer class="sl-footer">
        <div class="footer-left">
          <div class="mg-b-2">Copyright &copy; {{ Carbon\Carbon::now()->format('Y') }}. Bismillah. All Rights Reserved.</div>
