...
<div class="container">
	 <div class="row text-center">
			 <div class="alert alert-info">
				 <h1>Bismillah Group Online Payment</h1>
			 </div>
	</div>
                ...
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        ...
                        <div class="display-td" >
                            <img class="img-responsive pull-right" src="{{ asset('uploads/card.jpg')}}">
                        </div>
                    </div>
                </div>
                            ...
                            <div class='col-md-12 error form-group hide'>
                                <div class='alert-danger alert'>Please correct the errors and try
                                    again.</div>
												...
												<input type="hidden" name="name" value="{{ $request_all_data['name'] }}">
												<input type="hidden" name="email" value="{{ $request_all_data['email'] }}">
												<input type="hidden" name="phone" value="{{ $request_all_data['phone'] }}">
												...
												<input type="hidden" name="postcode" value="{{ $request_all_data['postcode'] }}">
												<input type="hidden" name="town" value="{{ $request_all_data['town'] }}">
												...
												<input type="hidden" name="payment_method" value="{{ $request_all_data['payment_method'] }}">
												{{-- @php
