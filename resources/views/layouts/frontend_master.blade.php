                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <ul class="d-flex header-contact">
                            <li><i class="fa fa-phone"></i> 0131234567</li>
                            <li><i class="fa fa-envelope"></i> infobismillahgroup@gmail.com</li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-12">
                          <ul class="d-flex account_login-area">
                              ...
                              {{-- <li><a href="{{ url('register') }}"> Admin Register </a></li> --}}
                          </ul>
                      </div>
                  </div>
              </di
                ...
                <div class="row">
                        ...
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown_style">
                                        <li class="@yield('shop')"><a href="{{ url('shop') }}">Shop Page</a></li>
                    ...
                    <div class="col-md-4 col-lg-2 col-sm-5 col-4">
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="flaticon-like"></i> <span>{{ App\Favourite::where('ip_address',request()->ip())->count() }}</span></a>
                                <ul class="cart-wrap dropdown_style">
                                  @php
                                    $sub_total = 0;
                                  @endphp
                                  @foreach (App\Favourite::where('ip_address',request()->ip())->get() as $fav_item)
                                    <li class="cart-items">
                                      <div class="cart-img">
                                        {{-- <img src="{{ asset('uploads/productthumbnail_photo') }}/{{ App\Product::find($fav_item->product_id)->product_thumbnail_photo }}" alt="not Found"> --}}
                                      </div>
                                      <div class="cart-content">
                                        <a href="cart.html">{{ App\Product::find($fav_item->product_id)->product_name }}</a>
                                        <span>QTY : {{ $fav_item->quantity }}</span>
                                        <p>${{ (App\Product::find($fav_item->product_id)->product_price) * $fav_item->quantity}}</p>
                                        @php
                                        $sub_total = $sub_total + (App\Product::find($fav_item->product_id)->product_price) * $fav_item->quantity;
                                        @endphp
                                        <i>
                                        <a href="{{ url('deleteFavtItem') }}/{{ $fav_item->id }}" class="fa fa-times"></a>
                                        </i>
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="flaticon-shop"></i> <span>{{ App\Cart::where('ip_address',request()->ip())->count() }}</span></a>
                                <ul class="cart-wrap dropdown_style">
                                  @php
                                    $sub_total = 0;
                                  @endphp
                                  @foreach (App\Cart::where('ip_address',request()->ip())->get() as $cart_item)
                                    <li class="cart-items">
                                        ...
                                        <div class="cart-content">
                                            <a href="cart.html">{{ App\Product::find($cart_item->product_id)->product_name }}</a>
                                            <span>QTY : {{ $cart_item->quantity }}</span>
                                            <p>${{ App\Product::find($cart_item->product_id)->product_price * $cart_item->quantity}}</p>
                                            @php
                                              $sub_total = $sub_total + (App\Product::find($cart_item->product_id)->product_price * $cart_item->quantity);
                                            @endphp
                                            <i >
                                              <a class="fa fa-times" href="{{url("deleteCartItem")}}/{{ $cart_item->id }}"></a>
                                            </i>
                                        </div>
                                    </li>
                                    @endforeach
                                    <li>Subtotol: <span class="pull-right">${{ $sub_total }}</span></li>
                                    <li>
                                        <a href="{{ url('cartpage') }}" class="btn btn-danger">Cart</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-8 col-sm-12">
                        <div class="footer-content">
                            <p>Bismillah Group is a business organization.We have online business, construction business, import export business and so on </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-8 col-sm-12">
                        <div class="footer-adress">
                            <ul>
                                <li><a href="#"><span>Email:</span> infobismillahgroup@gmail.com</a></li>
                                <li><a href="#"><span>Tel:</span> 0131234567</a></li>
                                <li><a href="#"><span>Adress:</span> Dhanmondi-15(Keary Plaza), House- 79, Dhaka- 1205</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <div class="footer-reserved">
                            <ul>
                                <li>Copyright © 2021 Bismillah Group All rights reserved.</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('#apply-coupon-btn').click(function(){
          ...
          var link_to_go = "{{ url('cartpage') }}/"+coupon_text;
