           ...
           <div class="row">
               <div class="col-lg-6">
                   <div class="product-single-img">
                       <div class="product-active owl-carousel">
                           <div class="item">
                               <img src="{{asset("uploads/productthumbnail_photo")}}/{{ $product_info->product_thumbnail_photo }}" alt="">
                           </div>
                           @foreach ($multiple_photos as $multiple_photo)
                             <div class="item">
                               <img src="{{ asset('uploads/product_multiple_photo') }}/{{ $multiple_photo->photo_name }}" alt="">
                             </div>
                           @endforeach
               ...
               <div class="col-lg-6">
                   <div class="product-single-content">
                       ...
                       <span class="text-danger"> <h4>Product Quantity: {{ $product_info->product_quantity }} </h4> </span>
                       ...
                       <ul class="input-style">
                         ...
                         <form action="{{ url('addtocart') }}" method="post">
                           ...
                           <form action="{{ url('addtofavourite') }}" method="post">
                             @csrf
                             <input type="hidden" name="product_id" value="{{$product_info->id}}">
                             <li class="quantity cart-plus-minus">
                                 <input type="text" name="quantity" value="1" />
                       ...
                       <ul class="cetagory">
                           <li>Categories:</li>
                           <li><a href="#">{{ $product_info->relationtocategorytable->Name }}</a></li>
                       </ul>
                       <ul class="socil-icon">
                           <li>Share :</li>
               ...
               <div class="col-lg-3 col-sm-6 col-12">
                   <div class="featured-product-wrap">
                       <div class="featured-product-img">
                           <img src="{{ asset('uploads/productthumbnail_photo') }}/{{ $rel_product->product_thumbnail_photo }}" alt="">
                       </div>
                       <div class="featured-product-content">
                           <div class="row">
                               <div class="col-7">
                                   <h3><a href="{{ url('productDetails/') }}/{{$rel_product->id}}">{{ $rel_product->product_name}}</a></h3>
