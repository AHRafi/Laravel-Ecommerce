...
@section('frontend_master')
            ...
            <div class="swiper-wrapper">
              @foreach ($banner_all as $banner)
                ...
                <div class="swiper-slide overlay">
                    <div class="single-slider slide-inner" style="background: url({{asset('uploads/banner')}}/{{$banner->banner_photo}})">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-lg-9 col-12">
                                    <div class="slider-content">
                                        <div class="slider-shape">
                                            <h2 data-swiper-parallax="-500">{{ $banner->name }}</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="featured-active2 owl-carousel next-prev-style">
                      @foreach ($categoey_all as $cat_all)
                        <div class="featured-wrap">
                          <div class="featured-img">
                            <img src="{{ asset('uploads') }}/{{ $cat_all->Category_Photo }}" alt="">
                            <div class="featured-content">
                              <a href="{{ url('shop') }}">{{ $cat_all->Name }}</a>
                            </div>
                          </div>
                        </div>
                      @endforeach
    ...
    <div class="product-area product-area-2">
        <div class="fluid-container">
            ...
            <ul class="row">
              @foreach ($best_seller as $b_seller)

                <li class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="product-wrap">
                        <div class="product-img">
                            <img src="{{ asset('uploads/productthumbnail_photo/')}}/{{ App\Product::find($b_seller->product_id)->product_thumbnail_photo }}" alt="">
                        ...
                        <div class="product-content">
                            <h3><a href="{{ url('productDetails') }}/{{ $b_seller->product_id }}">{{ App\Product::find($b_seller->product_id)->product_name }}</a></h3>
                            <p class="pull-left">${{ App\Product::find($b_seller->product_id)->product_price }}
